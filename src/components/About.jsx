            ...
            <div className="w-3/5">
              ...
              <div className="flex flex-row mt-6">
                <div className="mt-8 flex">
                  <Link to="/Resume - Spencer Hum.pdf" download className="bg-gray-300 hover:bg-gray-400 text-black font-bold py-4 px-8 rounded-lg flex justify-center items-center mr-4">
                    <span>Resume / CV</span>
